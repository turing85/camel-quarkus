...
class SwiftMxTest {
    ...
    void testUnmarshal(String mode) throws Exception {
        RestAssured.given() //
                ...
                .body(Files.readAllBytes(Paths.get("src/test/resources/mx/message1.xml")))
    ...
    void testUnmarshalFull() throws Exception {
        RestAssured.given() //
                .contentType(ContentType.TEXT)
                .body(Files.readAllBytes(Paths.get("src/test/resources/mx/message3.xml")))
    ...
    void testMarshal() throws Exception {
        RestAssured.given() //
                .contentType(ContentType.TEXT)
                .body(Files.readAllBytes(Paths.get("src/test/resources/mx/message2.xml")))
    ...
    void testMarshalJson() throws Exception {
        RestAssured.given() //
                ...
                .then()
                .body(equalTo(Files.readString(Paths.get("src/test/resources/mx/message2.json")).trim()))
                .statusCode(200);
    }
}
